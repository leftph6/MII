...
- 状态：通过
- Run ID：`5c4c1e9964d1415ba14b6d0811754ceb`
- 生成时间：2026-07-25T15:49:48+00:00
- 输出目录：`/Users/mashengyu/Desktop/quant research/market-intent-inference/harness-results/20260725T154947Z-domain-kernel-5c4c1e9964d1415ba14b6d0811754ceb`
...
|---|---:|---:|---:|---:|---:|
| `unit-tests` | 通过 | 0 | 0.347 | 0.347 | 1 |
| `compile` | 通过 | 0 | 0.207 | 0.207 | 1 |
| `security-boundary` | 通过 | 0 | 0.176 | 0.176 | 1 |
