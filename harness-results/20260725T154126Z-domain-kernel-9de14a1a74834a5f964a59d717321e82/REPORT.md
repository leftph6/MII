...
- 状态：通过
- Run ID：`9de14a1a74834a5f964a59d717321e82`
- 生成时间：2026-07-25T15:41:27+00:00
- 输出目录：`/Users/mashengyu/Desktop/quant research/market-intent-inference/harness-results/20260725T154126Z-domain-kernel-9de14a1a74834a5f964a59d717321e82`
...
|---|---:|---:|---:|---:|---:|
| `unit-tests` | 通过 | 0 | 0.532 | 0.532 | 1 |
| `compile` | 通过 | 0 | 0.204 | 0.204 | 1 |
| `security-boundary` | 通过 | 0 | 0.200 | 0.200 | 1 |
