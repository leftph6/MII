...
- 状态：通过
- Run ID：`332e3fd568d14511bd779cb79e02da12`
- 生成时间：2026-07-25T15:38:20+00:00
- 输出目录：`/Users/mashengyu/Desktop/quant research/market-intent-inference/harness-results/20260725T153819Z-domain-kernel-332e3fd568d14511bd779cb79e02da12`
...
|---|---:|---:|---:|---:|---:|
| `unit-tests` | 通过 | 0 | 0.354 | 0.354 | 1 |
| `compile` | 通过 | 0 | 0.214 | 0.214 | 1 |
| `security-boundary` | 通过 | 0 | 0.247 | 0.247 | 1 |
