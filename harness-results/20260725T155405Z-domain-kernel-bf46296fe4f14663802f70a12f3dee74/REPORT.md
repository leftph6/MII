...
- 状态：通过
- Run ID：`bf46296fe4f14663802f70a12f3dee74`
- 生成时间：2026-07-25T15:54:06+00:00
- 输出目录：`/Users/mashengyu/Desktop/quant research/market-intent-inference/harness-results/20260725T155405Z-domain-kernel-bf46296fe4f14663802f70a12f3dee74`
...
|---|---:|---:|---:|---:|---:|
| `unit-tests` | 通过 | 0 | 0.559 | 0.559 | 1 |
| `compile` | 通过 | 0 | 0.222 | 0.222 | 1 |
| `security-boundary` | 通过 | 0 | 0.213 | 0.213 | 1 |
